            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (true) {
                    ...
                    if (t_data.Properties.ContainsKey (property)) {
						...
						{
							var val = ReadValue(prop_data.Type, reader);

							if( prop_data.Type == typeof(float) )
							{
                                var t = val.GetType();
                                float f = 0.0f;
                                ...
                                ((FieldInfo)prop_data.Info).SetValue(instance, f);
                            }
							else
							{
								( (FieldInfo)prop_data.Info ).SetValue(instance, val);
							}
						} else {
                            PropertyInfo p_info =
